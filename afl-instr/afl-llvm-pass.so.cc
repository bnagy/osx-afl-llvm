...
// CHANGES (bn)
// Don't use SAYF macro, doesn't compile with clang
// Change imports to config / debug to . from ..
// Add debugging printf to registerAFLPass
// Add module loaded printf
...
{
  printf("Trying to register pass...\n");
  PM.add(new AFLCoverage());
  printf("pass is registered!\n");
